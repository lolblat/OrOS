...
CPP_HEADERS = $(wildcard drivers/*.h cpu/*.h Util/*.h cpu/interrupts/*.h MemoryAllocation/Paging.h tasks/*.hpp MemoryAllocation/BitMapAllocator.h  MemoryAllocation/MemoryManager.h FileSystemEXT2/*.h MemoryAllocation/Operators.h )
