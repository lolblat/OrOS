...
CPP_SOURCES = $(wildcard drivers/*.cpp cpu/*.cpp Util/*.cpp cpu/interrupts/*.cpp MemoryAllocation/*.cpp)
CPP_HEADERS = $(wildcard drivers/*.h cpu/*.h Util/*.h cpu/interrupts/*.h MemoryAllocation/*.h)
